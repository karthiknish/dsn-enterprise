								...
								{topPages.length > 0 ? (
									topPages.map((row) => {
										...
										const totalViews = topPages.reduce(
											(acc, r) => acc + parseInt(r.metricValues[0].value, 10),
											0,
										);
				...
				<div className="space-y-6">
					<div className="bg-gradient-to-br from-accent to-accent-700 rounded-xl shadow-lg p-6 text-white">
						...
						<p className="text-accent-50 opacity-90 text-sm leading-relaxed">
							Your bounce rate is currently{" "}
							{getMetricValue(3)
								? (parseFloat(getMetricValue(3)) * 100).toFixed(1)
								: "..."}
							%. To improve engagement, try adding more internal links in your
							blog posts and clarifying call-to-actions on product pages.
						</p>
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-xs text-gray-500">
										Monitor your peak hours to schedule new blog post launches
