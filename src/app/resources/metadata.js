export const metadata = {
	...
	openGraph: {
		title:
			"Resources & Downloads | Product Catalogs & Technical Resources - DSN Enterprises",
		description:
			"Access product catalogs, technical resources, gauge tolerance charts, thread data tables, API specifications, and quality certificates.",
	...
	twitter: {
		...
		description:
			"Access product catalogs, technical resources, gauge tolerance charts, thread data tables, and API specifications.",
