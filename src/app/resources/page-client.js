							...
							>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									{category.items.map((item) => (
										<div
											key={item.name}
											className="bg-gray-50 rounded-2xl border border-gray-100 p-5 flex items-start gap-4 hover:shadow-md transition-shadow"
										>
					...
					<div className="max-w-5xl mx-auto">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-gray-600 max-w-2xl mx-auto">
								Our gauges are manufactured to comply with national and
					...
					<div className="max-w-4xl mx-auto">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
							{[
								...
								<div
									key={org.abbr}
									className="bg-gray-50 rounded-2xl border border-gray-100 p-6 text-center hover:shadow-md transition-shadow"
								>
									<FaIndustry className="text-3xl text-primary mx-auto mb-3" />
									<h3 className="font-semibold text-gray-900">{org.abbr}</h3>
